...
if (isset($_GET['id_persona']))
{
    ...
    $con->sin_retorno($sql);
    $sql="delete from cuenta where usuario_persona_id_persona='$_GET[id_persona]'";
    $con->sin_retorno($sql);
...
join tramite_plantilla t2 on t.Tramite_plantilla_idTramite_plantilla = t2.idTramite_plantilla where email = '$cor';";
            return $this->obj_con->con_retorno($sql);
        }
