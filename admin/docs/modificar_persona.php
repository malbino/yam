                ...
                <div class="tile-body">
                    <form action="../../enrutador/enr_agregarusuario.php" method="post" autocomplete="off" required>
                        <div class="form-group row">
                            ...
                            <input hidden class="form-control" type="text" name="id_persona" id="id_persona" value="<?php echo $_GET['id_persona'];?>">
                            <input hidden class="form-control" type="text" name="rol" id="rol" value="<?php echo $_GET['rol'];?>">
