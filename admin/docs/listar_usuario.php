...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="agregar-empleado.php">Registrar Personas</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        while($row=mysqli_fetch_assoc($datos)){
                           ...
                           // echo "<td>".$row['persona_id_persona']."</td>";
                            ...
                            echo "<td><a class='btn btn-danger col-md-6' href='../../modelo/mdl_login.php?id_persona=".$id_persona."'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
                            echo "</tr>";
                        }?>
                        </tbody>
                    </table>
